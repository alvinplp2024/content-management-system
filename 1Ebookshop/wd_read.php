...
<form class="example" action="search.php" method="get" style="margin:auto;max-width:800px">
  ...
  <div class="row">
    ...
    <div class="row">
        <p>
            <strong>Course Title: Comprehensive Introduction to Web Development Programming</strong>
        </p>
        <p>
        <strong>Course Overview</strong><br>
            Web design is the art and science of creating websites that are visually appealing, 
            user-friendly, and functional. It involves a blend of graphic design, coding, 
            and user experience (UX) principles to create interfaces that engage users and 
            effectively communicate content. This course explores essential tools and techniques 
            for building websites, including HTML for structure, CSS for styling, and JavaScript 
            for interactivity. By the end of the course, students will be able to create responsive, 
            accessible, and modern web pages suitable for personal portfolios, business purposes, 
            or professional web development.
        </p>
    </div>
    <!-- Button Link Below the Text, Above the Footer -->
    <div class="row" style="margin-top: 250px;">
        <a href="content/web_design.php" class="btn btn-primary" style="display: block; margin: 0 auto;">Start Learning Web Design</a>
    </div>
</div>
