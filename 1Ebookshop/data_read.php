...
<form class="example" action="search.php" method="get" style="margin:auto;max-width:800px">
  ...
  <div class="row">
    ...
    <div class="row">
        <p>
            <strong>Course Title: Comprehensive Introduction to Data Science</strong>
        </p>
        <p>
        <strong>Course Overview</strong><br>
            Data Science is an interdisciplinary field that combines computer science, statistics, 
            and domain expertise to extract insights and knowledge from structured and unstructured data. 
            It plays a crucial role in modern decision-making processes across industries such as healthcare, 
            finance, marketing, and technology. In this course, learners will explore the fundamental concepts 
            and tools used in data science, including data collection, cleaning, exploration, and analysis,
             as well as advanced topics like machine learning and data visualization.
        </p>
    </div>
    <!-- Button Link Below the Text, Above the Footer -->
    <div class="row" style="margin-top: 250px;">
        <a href="content/data_science.php" class="btn btn-primary" style="display: block; margin: 0 auto;">Start Learning Data Science</a>
    </div>
</div>
