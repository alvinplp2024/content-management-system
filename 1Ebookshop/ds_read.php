...
<form class="example" action="search.php" method="get" style="margin:auto;max-width:800px">
  ...
  <div class="row">
    ...
    <div class="row">
        <p>
            <strong>Course Title: Comprehensive Introduction to Data Structures</strong>
        </p>
        <p>
        <strong>Course Overview</strong><br>
            Data Structures are fundamental to computer science and software engineering. 
            They provide a way of organizing and storing data so that it can be accessed and 
            modified efficiently. In this course, learners will explore the essential data structures 
            like arrays, linked lists, stacks, queues, trees, and graphs. The course also covers algorithms 
            for manipulating these data structures and their real-world applications in solving complex 
            computational problems.
        </p>
    </div>
    <!-- Button Link Below the Text, Above the Footer -->
    <div class="row" style="margin-top: 250px;">
        <a href="content/data_structure.php" class="btn btn-primary" style="display: block; margin: 0 auto;">Start Learning Data Structures</a>
    </div>
</div>
