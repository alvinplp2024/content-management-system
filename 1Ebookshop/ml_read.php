...
<form class="example" action="search.php" method="get" style="margin:auto;max-width:800px">
  ...
  <div class="row">
    ...
    <div class="row">
        <p>
            <strong>Course Title: Comprehensive Introduction to AI and ML</strong>
        </p>
        <p>
            <strong>Course Overview</strong><br>
            Artificial Intelligence (AI) and Machine Learning (ML) are key technologies 
            transforming industries across the world. This course covers the fundamental concepts 
            of AI and ML, including algorithms, models, and practical applications. It explores 
            supervised and unsupervised learning, deep learning, natural language processing, and 
            reinforcement learning. By the end of the course, learners will have hands-on experience 
            with implementing ML algorithms and AI applications using popular libraries like TensorFlow 
            and scikit-learn.
        </p>
    </div>
    <!-- Button Link Below the Text, Above the Footer -->
    <div class="row" style="margin-top: 250px;">
        <a href="content/machine.php" class="btn btn-primary" style="display: block; margin: 0 auto;">Start Learning Machine Learning</a>
    </div>
</div>
