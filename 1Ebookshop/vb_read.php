...
<form class="example" action="search.php" method="get" style="margin:auto;max-width:800px">
  ...
  <div class="row">
    ...
    <div class="row">
        <p>
            <strong>Course Title: Comprehensive Introduction to Visual Basic</strong>
        </p>
        <p>
        <strong>Course Overview</strong><br>
            Visual Basic (VB) is a high-level programming language developed by Microsoft that is 
            designed for rapid application development (RAD). It provides an easy-to-use interface and a 
            powerful event-driven programming environment, making it ideal for beginners and experienced 
            developers alike. This course covers the basics of VB programming, including variables, data 
            types, control structures, and user interface design, along with more advanced topics like 
            object-oriented programming and database integration.
        </p>
    </div>
    <!-- Button Link Below the Text, Above the Footer -->
    <div class="row" style="margin-top: 250px;">
        <a href="content/visual_basic.php" class="btn btn-primary" style="display: block; margin: 0 auto;">Start Learning Visual Basic</a>
    </div>
</div>
